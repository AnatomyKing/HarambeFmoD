        ...
        d.register(Commands.literal("balance")
                ...
                .then(Commands.argument("player", GameProfileArgument.gameProfile())
                        .executes(ctx -> {
                            ...
                            String disp = Abbrev.format(bal);
                            ctx.getSource().sendSuccess(
                                    () -> Component.literal(nameOf(gp) + "'s balance: ").withStyle(ChatFormatting.GRAY)
                                            .append(Component.literal(disp).withStyle(ChatFormatting.GOLD))
                                            .append(Component.literal(" (" + bal + ")").withStyle(ChatFormatting.DARK_GRAY)),
                                    false
                            );
                                        ...
                                        .executes(ctx -> {
                                            ...
                                            ctx.getSource().sendSuccess(
                                                    () -> Component.literal("Added ").withStyle(ChatFormatting.GRAY)
                                                            .append(Component.literal(Abbrev.format(amount)).withStyle(ChatFormatting.GREEN))
                                                            .append(Component.literal(" to " + nameOf(gp) + ". New balance: ").withStyle(ChatFormatting.GRAY))
                                                            .append(Component.literal(Abbrev.format(after)).withStyle(ChatFormatting.GOLD))
                                                            .append(Component.literal(" (" + after + ")").withStyle(ChatFormatting.DARK_GRAY)),
                                                    true
                                            );
                                            return 1;
                                        })
                                        ...
                                        .executes(ctx -> {
                                            ...
                                            ctx.getSource().sendSuccess(
                                                    () -> Component.literal("Removed ").withStyle(ChatFormatting.GRAY)
                                                            .append(Component.literal(Abbrev.format(amount)).withStyle(ChatFormatting.RED))
