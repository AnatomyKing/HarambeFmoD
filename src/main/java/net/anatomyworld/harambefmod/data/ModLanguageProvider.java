...
public final class ModLanguageProvider extends LanguageProvider {
    private static final String MODID = "harambefmod";
    ...
    protected void addTranslations() {
        ...
        // 2) Items that are NOT BlockItems -> item.modid.<id> = Human Name
        ...
        String tabKey = "itemGroup." + MODID + ".harambe_tab";
        add(tabKey, OVERRIDES.getOrDefault(tabKey, "HarambeFD"));
